...
console.log(fibonacciNumbers.unshift(4))
console.log(fibonacciNumbers.push(15))
console.log(fibonacciNumbers.push(16))
...
const newArray = ['dog', 'cat', 'hampster', 'rabbit', 'lizzard']
...
const emptyArray = [];
console.log(emptyArray.unshift(4, 6, 7));
console.log(emptyArray.push(15, 18));
...
const copyStudents = students.slice(3, 11);
...
const reversed = dinosaurs.reverse()
